...
public class HashUtils {
    ...
    public static void main(String... args) {
        System.out.println(md5("thanh"));
        System.out.println(md5("thanh".getBytes()));
        System.out.println(crc32("thanh"));
        System.out.println(crc32("thanh".getBytes()));
        System.out.println(sha1("thanh"));
        System.out.println(sha1("thanh".getBytes()));
        System.out.println(sha256("thanh"));
        System.out.println(sha256("thanh".getBytes()));
        System.out.println(sha512("thanh"));
        System.out.println(sha512("thanh".getBytes()));
    }
}
